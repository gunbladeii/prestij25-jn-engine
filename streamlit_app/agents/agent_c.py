...
Generates enforcement directives and evidence-based policy recommendations
grounded in Malaysian education law and ministry circulars.
"""
...
# ---------------------------------------------------------------------------
# Enforcement action matrix: keyed by DI classification
# Ordered by urgency (first item = highest priority action)
# ---------------------------------------------------------------------------
...
# Policy recommendation templates, keyed by flag type
